...
import { Plus, Pencil, Trash2, Tag, Eye, EyeOff, Upload, ImageIcon, LayoutList, LayoutGrid } from "lucide-react";
...
export default function CategoriesPage() {
  ...
  return (
    <>
      <Layout
        title="Categorías"
        subtitle="Organiza el catálogo del marketplace por categorías."
        variant="table"
        toolbar={toolbar}
      >
