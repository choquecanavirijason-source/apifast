        ...
        createPortal(
          <>
            ...
            @media print {
              ...
              /* El ticket vive dentro de #root; ocultar el resto sin depender de body > * */
              body * {
                visibility: hidden;
              }
              ...
              #pos-receipt-print-root .no-print {
            ...
            >
              ...
              >
                ...
                <div className="no-print flex gap-2 px-5 pb-5">
                  ...
                  <button
                    type="button"
                    onClick={handlePrintTicketModel}
